                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
								<div class="row">
									<div class="col-md-12">
										<h2><center>Winner</center></h2>
										<form action="report_winner_show.php" method="post">
											...
											<select name="gna" class="form-control" required>
												...
												<?php 
													...
													{
												?>
												<option value="<?php echo $row['game_id']?>"><?php echo $row['gname'];?></option>
													<?php } ?>
											</select><br><br>
										
											<input type="submit" name="submit" class="btn btn-success">
										</form><br>
										<a href="report_winner_all.php" style="color:white;text-decoration:none;"><button class="btn btn-success" value="All">All</button></a><br><br>
									</div>
								</div>
                            </div>
                        </div>
