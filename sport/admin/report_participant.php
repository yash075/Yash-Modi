...
<head>
    ...
    <title>Report | Participant</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
								<div class="row">
									<div class="col-md-12">
										<h2><center>Participant</center></h2>
										<form action="report_participant_show.php" method="post">
											<label>Game</label>
											<select name="gna" class="form-control" required>
												...
												<?php 
													...
													{
												?>
													<option value="<?php echo $row1['game_id'];?>"><?php echo $row1['gname'];?></option>
													<?php } ?>
											</select>
											...
											<select name="sm" class="form-control" required>
												...
												<?php 
													...
													{
												?>
												<option value="<?php echo $row['team_id']?>"><?php echo $row['team_name'];?>-----<?php echo $row['sem'];?></option>
													<?php } ?>
											</select><br><br>
										...
										<a href="report_participant_all.php" style="color:white;text-decoration:none;"><button class="btn btn-success" value="All">All</button></a><br><br>
									</div>
								</div>
                            </div>
                        </div>
