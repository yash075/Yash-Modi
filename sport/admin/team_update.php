        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<?php
					...
					$query = "select * from team where team_id ='$d'; ";
                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										<form action="team_update_val.php?id=<?php echo $_GET['id'];?>" method="post">
											<label>Semester</label>
											<input type="text" class="form-control" name="sem" value="<?php echo $num['sem']; ?>"><br><br>
											<label>Team Name</label>
											<input type="text" class="form-control" name="tname" value="<?php echo $num['team_name'];?>"><br><br>																						
