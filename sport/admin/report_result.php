                            ...
                            <div class="card-block">
								<div class="row">
									<div class="col-md-12">
										...
										<form action="report_result_show.php" method="post">
										...
										<a href="report_result_all.php" style="color:white;text-decoration:none;"><button class="btn btn-success" value="All">All</button></a><br><br>
									</div>
								</div>
                            </div>
                        </div>
