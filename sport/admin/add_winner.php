                        ...
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6">	
										<form action="add_winner_val.php" method="post">
											<label>Result Id</label>
											<select name="rlist" class="form-control" >
												<option name="" selected disabled>Select Result Id</option>
												<?php
													while($row1 = mysqli_fetch_assoc($result1))
													{
												?>
												
												<option value="<?php echo $row1['r_id']?>"><?php echo $row1['r_id'];?></option>
													<?php } ?>
											</select>
											<label>Game Id</label>
											<select name="glist" class="form-control" id="gameget">
											...
											<input type="text" name="mans" class="form-control">
											<label>Man Of The Match</label>
											<input type="text" name="manm" class="form-control">
											<label>Best Batsman</label>
											<input type="text" name="bbat" class="form-control">
											<label>Best Bowler</label>
											<input type="text" name="bbowl" class="form-control">
