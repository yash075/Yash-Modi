                        ...
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-4">
										<div class="text-center text-danger">Add Participant<br><br></div>
										<form action="add_participant_val.php" method="post">
											<label>Enrollment No.</label>
											<input type="text" name="eno" maxlength="11" class="form-control" required>
											<label>Name</label>
											<input type="text" name="pn" class="form-control" required>
											<label>Birth Date</label>
											<input type="date" name="bdate" class="form-control" required>
											<label>Mobile No.</label>
											<input type="text" name="mno" maxlength="10" class="form-control" required>
											<label>Class</label>
											...
											<label>Team Id</label>
											<select name="tlist" class="form-control" required>
											...
											<label>Game Id</label>
											<select name="glist" class="form-control" required>
												<option value="" selected disabled>Select Game Id</option>
												<?php
											...
											<select name="pty" class="form-control" required>
												<option name="" selected disabled>Select Player Type</option>
