                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="../admin/game_show.php">Games</a></li>
                            <li class="breadcrumb-item active">Search Games</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									<div class="col-md-2">
										<button class="btn btn-success"><a href="../admin/game_show.php" style="color:white;text-decoration:none;">Back</a></button>
									</div>
									...
									<div class="col-md-12">
										...
										<table class="table table-stripped">
											...
											<?php
												...
												$g = $_POST['find'];
												$sql = "select * from game where gname like '$g%' OR type like '$g%';";
