                            ...
                            <div class="card-block">
								<div class="row">
									...
									<div class="col-md-4 text-center">
										<form action="add_schedule_val.php" method="post">
											<label>Game Id</label>
									...
									<option value="" selected disabled>Select Game Name</option>
										...
										?>
											...
											<label>Date</label>
											<input type="date" class="form-control" name="dt" required><br><br>
											<label>Time</label><br>
											<input type="text" name="sctime" class="form-control"><br><br>
											<label>Status</label><br>
											<input type="radio" value="Active" name="st">Active<br>
											<input type="radio" value="Cancel" name="st">Cancel<br><br>
