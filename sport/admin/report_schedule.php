                            ...
                            <div class="card-block">
								<div class="row">
									<div class="col-md-12">
										...
										<form action="report_schedule_show.php" method="post">
											...
											<select name="sdate" class="form-control" required>
												...
												<?php 
													$sql1 = "select * from schedule group by s_date";
													$res1 = mysqli_query($con,$sql1);
													while($row1 = mysqli_fetch_assoc($res1))
													{
												?>
													<option value="<?php echo $row1['s_date'];?>"><?php echo $row1['s_date'];?></option>
													<?php } ?>
											</select><br><br>
											<input type="submit" name="submit" class="btn btn-success">
										</form><br>
										<a href="report_schedule_all.php" style="color:white;text-decoration:none;"><button class="btn btn-success" value="All">All</button></a><br><br>
									</div>
								</div>
                            </div>
                        </div>
