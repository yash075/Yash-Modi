        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
					...
					$query = "select * from room_arrangement where r_id ='$d'; ";
                        ...
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									...
									<form name="myForm" action="room_arrangement_update_val.php?id=<?php echo $d; ?>" method="post">
										
                                            <label style="color:blue;font-size:20px;">Room Name </label>
											<input type="text" class="form-control" name="name" value="<?php echo $num['r_name']; ?>"><br><br>
