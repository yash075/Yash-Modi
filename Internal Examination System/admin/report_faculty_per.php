                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										<form action="report_faculty_per_show.php" method="get">
                                            
                                            <label for="time" style="color:blue;font-size:20px;">Faculty Name</label>
                                            <select name="f_id" class="form-control" required>
		                                   <option value="" selected disabled>Select faculty</option>
			                               <?php
     
                                            $query=mysqli_query($con,"select * from faculty order by f_code;");
