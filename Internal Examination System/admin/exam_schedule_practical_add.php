                    ...
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item"><a href="../admin/examination_schedule.php">Exam Generation</a></li>
                            <li class="breadcrumb-item"><a href="../admin/exam_schedule_practical.php?id=<?php echo $_GET['id'];?>">Practical Exam Details</a></li>
                            <li class="breadcrumb-item active">Add Practical Schedule</li>
                        </ol>
                    </div>Practical             
                </div>
                <!-- ============================================================== -->
                            ...
                            <div class="card-block">
                                <div class="row">
                                    ...
                                    <?php 
                                        ...
                                        //echo $result;
                                    ?>
										<form action="exam_schedule_practical_add_1.php?id=<?php echo $g;?>" method="POST">
...
$(document).ready(function(){
	$("#course").on('change',function(){
		...
		$.ajax({
			method:"POST",
			url:"ajax/semester_exam1_ajax.php",
