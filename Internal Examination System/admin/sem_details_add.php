            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Semester Details</h3>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add Sem</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										...
										<form action="../admin/sem_details_add_val.php" method="post">
											...
											<input type="text" class="form-control" name="sem_code" required><br><br>
                                            
                                            <label style="color:blue;font-size:20px;">Semester Type</label><br>
