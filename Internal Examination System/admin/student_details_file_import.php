                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">File Import Student</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										<form action="student_details_file_import_val.php" method="post" enctype="multipart/form-data">
			                               ...
			                               <?php
                                            ...
                                            <label style="color:blue;font-size:20px;">File Import</label><br>
                                            <p> must be file extension is .csv & colums must be arrange in <br> Eno. |  name  | mobile no | Email <br></p>
	...
	function() {
		...
		function() {
			...
			return true;
											...
											<input type="submit" id="submit" name="import" class="btn btn-success" value="Submit">
										</form>
<script>
