                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Search Course Details</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									<div class="col-md-2">
										<button class="btn btn-success"><a href="../admin/course_details.php" style="color:white;text-decoration:none;"><i class="fa fa-arrow-left m-r-10" style="font-size:18px" aria-hidden="true"></i> Back</a></button>
									</div>
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-12">
											<h2 class="text-danger text-center">Search Course</h2>
											<table class="table table-bordered"  style="text-align:center;" >
												<thead>
													...
													<?php
                                                        ...
                                                        {
												            $g = $_POST['find'];
												            $sql = "select * from course where course_code like '$g%' OR course_name like '$g%' OR course_type like '$g%' order by course_name,course_code;";
                                                        }
                                                        else
                                                        {
