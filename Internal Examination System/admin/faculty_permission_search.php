                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            <form class="app-search p-l-20" action="faculty_permission_search.php" method = "post">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Search Faculty Permission</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									<div class="col-md-2">
										<button class="btn btn-success"><a href="../admin/faculty_permission.php" style="color:white;text-decoration:none;"><i class="fa fa-arrow-left m-r-10" style="font-size:18px" aria-hidden="true"></i> Back</a></button>
									</div>
									<div class="col-md-6">
                                        ...
                                        <form action="faculty_permission_delete_checkbox.php" method="post">
								...
								<div class="row">
									<div class="col-md-12">
											<h2 class="text-danger text-center">Search Faculty Permission</h2>
											<table class="table table-bordered" style="text-align:center;">
												<thead>
													<tr style="color:blue;font-size:20px;">
                                                        <th></th>
                                                        <th style="text-align:center;">No.</th>
														<th style="text-align:center;">Fac code & Name</th>
													...
													?>
                                                     <tbody>   
													<tr>
                                                         <td><input type="checkbox" id="checkItem" name="check[]" value="<?php echo $row["fac_per_id"]; ?>"></td>
														...
														<td><a href="faculty_permission_update.php?id=<?php echo $row['fac_per_id'];?>" style="color:green;text-decoration:none;"><i class="fa fa-edit m-r-10" style="font-size:18px" aria-hidden="true"></i></a></td>
													</tr>
													<?php
                                                            $no++;
														}
