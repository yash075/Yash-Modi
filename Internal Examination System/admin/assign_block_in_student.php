<?php
	...
	{
        if(!isset($_GET['id'])){
            header('location:assign_block_arrangement.php');
        }
        $id = $_GET['rid'];
?>
<!DOCTYPE html>
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="../admin/assign_block_arrangement.php?id=<?php echo $id;?>">Block Arrangement</a></li>
                            <li class="breadcrumb-item active">Assign In Student</li>
                        </ol>
                    </div>
									...
									<div class="col-md-12">
										...
										<table class="table table-bordered" style="text-align:center;">
											...
											<?php
												...
												$sql = "SELECT assign_block.ass_b_id,exam_schedule_theory.date,exam_schedule_theory.time,subject.sub_code,subject.sub_name,semester.sem_code,course.course_name,student.stud_code,student.stud_name FROM assign_block INNER JOIN block_arrangement ON block_arrangement.b_arr_id=assign_block.b_arr_id INNER JOIN exam_schedule_theory ON exam_schedule_theory.exam_sch_th_id=block_arrangement.exam_sch_th_id INNER JOIN subject ON subject.sub_id=exam_schedule_theory.sub_id INNER JOIN semester ON semester.sem_id=subject.sem_id INNER JOIN course ON course.course_id=semester.course_id JOIN student ON student.stud_id=assign_block.stud_id WHERE assign_block.b_arr_id='$g' order by student.stud_code;";
											...
											<tbody>
												<tr>
                                                    ...
                                                    <td><?php echo $row['stud_code']." - ".$row['stud_name'];?>
                                                    <td><a href="assign_block_in_student.php?id=<?php echo $row['b_arr_id'];?>" style="color:orange;text-decoration:none;"><i class="fa fa-edit m-r-10" style="font-size:18px;color:green;" aria-hidden="true"></i></a></td>
												</tr>
											<?php
                                                    $no++;
												}
