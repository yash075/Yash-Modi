                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										<form action="block_arrangement_multiple_add_1.php" method="get">
			                               ...
			                               <?php
                                            ...
                                            <label for="time" style="color:blue;font-size:20px;">No of Blocks</label>
                                            <input type="number" class="form-control" name="no_blocks" min="1"  placeholder="Enter the no of Blocks"><br><br>
