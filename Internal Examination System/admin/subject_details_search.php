                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Search Subject</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									<div class="col-md-2">
										<button class="btn btn-success"><a href="../admin/subject_details.php" style="color:white;text-decoration:none;"><i class="fa fa-arrow-left m-r-10" style="font-size:18px" aria-hidden="true"></i> Back</a></button>
									</div>
									<div class="col-md-6">
                                        ...
                                        <form action="subject_details_delete_checkbox.php" method="post">
								...
								<div class="row">
									<div class="col-md-12">
                                        <h2 class="text-danger text-center">Search Subject</h2>
										<table class="table table-bordered"  style="text-align:center;">
											...
											<?php
                                                ...
                                                if(isset($_POST['find']))
                                                        {
												            $g = $_POST['find'];
												            $sql = "select * from subject where sub_code like '%$g%' OR sub_name like '$g%' OR sub_type like '%$g%' order by sub_code;";
                                                        }
                                                        else
                                                        {
											...
											<tbody>
												<tr>
                                                    <td><input type="checkbox" id="checkItem" name="check[]" value="<?php echo $row["sub_id"]; ?>"></td>
                                                    <td style="color:blue;"><?php echo $no;?></td>
													<td><?php echo $row['sub_code'];?></td>
													<td><?php echo $row['sub_name'];?></td>
													<td><?php echo $row['sub_type'];?></td>
													<td><a href="subject_details_update.php?id=<?php echo $row['sub_id'];?>" style="color:green;text-decoration:none;"><i class="fa fa-edit m-r-10" style="font-size:18px" aria-hidden="true"></i></a></td>
												</tr>
											<?php
                                                    $no++;
												}
