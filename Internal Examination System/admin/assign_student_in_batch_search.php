                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Search Student Batch Details</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									<div class="col-md-2">
										<button class="btn btn-success"><a href="../admin/assign_student_in_batch.php" style="color:white;text-decoration:none;"><i class="fa fa-arrow-left m-r-10" style="font-size:18px" aria-hidden="true"></i> Back</a></button>
									</div>
									<div class="col-md-6">
                                        ...
                                        <?php
                                            include '../admin/connection.php';
                                                        ...
                                                        {   
                                                            ...
                                                            {
                                                                $sql = "select assign_student_in_batch.ass_stud_b_id,student.stud_code,student.stud_name,semester.sem_code,course.course_name,batch.batch_name from assign_student_in_batch inner join student on student.stud_id=assign_student_in_batch.stud_id inner join semester on semester.sem_id=student.sem_id inner join course on semester.course_id=course.course_id join batch on batch.batch_id=assign_student_in_batch.batch_id where student.stud_status=1 AND semester.sem_code='$g' order by course.course_name,semester.sem_code,student.stud_code;";
                                                            ...
                                                            {
                                                                $sql = "select assign_student_in_batch.ass_stud_b_id,student.stud_code,student.stud_name,semester.sem_code,course.course_name,batch.batch_name from assign_student_in_batch inner join student on student.stud_id=assign_student_in_batch.stud_id inner join semester on semester.sem_id=student.sem_id inner join course on semester.course_id=course.course_id join batch on batch.batch_id=assign_student_in_batch.batch_id where student.stud_status=1 AND (student.stud_code like '$g%' OR student.stud_name like '%$g%' OR semester.sem_code like '$g%' OR course.course_name like '$g%' OR
                                                                batch.batch_name like '$g%') order by course.course_name,semester.sem_code,student.stud_code;";
								...
								<div class="row">
									...
									<h2 class="text-danger text-center">Search Student in Batch Details</h2>
                                        <?php
                                    if($num > 0)
                                            {   
                                        ?>
