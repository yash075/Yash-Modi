<?php
	...
	if($s == TRUE)
	{
         if(!isset($_GET['sem_id'])){
            header('location:report_exam_schedule.php');
        }
        $sem = $_GET['sem_id'];
?>
<!DOCTYPE html>
                    ...
                    <div class="col-md-6 col-8 align-self-center">
                       <h3 class="text-themecolor m-b-0 m-t-0">Report</h3>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Examination Schedule show</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									<div class="col-md-3"><button class="btn btn-success"><a href="../admin/report_exam_schedule.php" style="color:white;text-decoration:none;"><i class="fa fa-arrow-left m-r-10" style="font-size:18px;text-align:center" aria-hidden="true"></i> Back</a></button></div>
                                     <div class="col-md-4">
									...
									<div class="text-center">
                                        ...
                                        $sql = "select semester.sem_code,course.course_code,course.course_name from semester inner join course on course.course_id=semester.course_id where semester.sem_id='$sem';";
                                        $result=mysqli_query($con,$sql);
                                        $ss = mysqli_fetch_assoc($result);
                                        $course= $ss['course_code']." - ".$ss['course_name']." - ".substr($ss['sem_code'],2);
                                        ?>
                                        <h2 class="text-danger text-center"><?php echo $course;?></h2><br>
                                         <h2 class="text-danger text-center">Theory Schedule</h2>
                                    <?php 
                                       
                                        $sql = "select exam_schedule_theory.date, exam_schedule_theory.time,subject.sub_name,subject.sub_code from  exam_schedule_theory inner join subject on subject.sub_id= exam_schedule_theory.sub_id where subject.sem_id='$sem' order by subject.sub_code;";
                                        $result=mysqli_query($con,$sql);
                                    ...
                                    ?>
                                        ...
                                        {
                                            ?><h2 class="text-danger text-center">Not Inserted Theory Schedule</h2><?php
                                        }
                                            ?>
                                            <br>
                                            <br>
                                    ...
                                    ?>
                                        ...
                                        {
                                            ?><h2 class="text-danger text-center">Not Inserted Practical Schedule</h2><?php
                                        }
                                            ?>
