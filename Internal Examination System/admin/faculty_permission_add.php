                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Assign Faculty Permission</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										...
										<form action="../admin/faculty_permission_add_val.php" method="post">
			                               ...
			                               <?php
                                            ...
                                            <?php
														$sql = "select batch_name from batch order by batch_name";
														$result = mysqli_query($con,$sql);
							
														while($row=mysqli_fetch_assoc($result))
														{
													?>
                                            <input type="checkbox" id="checkItem" name="batch_name[]" value="<?php echo $row['batch_name']; ?>"><?php echo $row['batch_name']; ?> &emsp;
                                                    <?php
                                                        }
                                                    ?>
