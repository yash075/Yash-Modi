                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                       ...
                       <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add Blocks</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-block">
                                <div class="row">
                                    ...
                                    <?php 
                                        ...
                                        $r_name=$row['r_name'];
                                        $sql11="select course.course_id,course.course_code,course.course_name from exam_schedule_theory inner join subject on subject.sub_id=exam_schedule_theory.sub_id inner join semester on semester.sem_id=subject.sem_id inner join course on course.course_id=semester.course_id group by course.course_name order by course.course_name;";
                                    ?>
                                    <div>
                                    <h2 class="text-danger text-center">Blocks Add</h2>
										<form action="block_arrangement_add_val.php?id=<?php echo $room_id;?>&no_blocks=<?php echo $no_blocks;?>" method="POST">
                                        <table class="table table-stripped"  style="text-align:center;">
                                            ...
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="b_name<?php echo $i;?>" placeholder="Block No." required>
                                                    </td>
                                                    <td>
                                                        <select name="course_id<?php echo $i;?>" class="form-control" id="course<?php echo $i;?>" required>
                                                    ...
                                                    <td>
                                                         <select name="sem_id<?php echo $i;?>" class="form-control" id="semester<?php echo $i;?>" required>
...
$(document).ready(function(){
	...
	$("#course<?php echo $i;?>").on('change',function(){
		var courseId=$(this).val();
		$.ajax({
			method:"POST",
			url:"ajax/sem_ajax.php",
			data:{course_id:courseId},
			dataType:"html",
			success:function(data){
				$("#semester<?php echo $i;?>").html(data);
			}
		});
	});
    
    $("#semester<?php echo $i;?>").on('change',function(){
		var semesterId=$(this).val();
		$.ajax({
			method:"POST",
			url:"ajax/sub_ajax.php",
			data:{semester_id:semesterId},
			dataType:"html",
			success:function(data){
				$("#subject<?php echo $i;?>").html(data);
			}
		});
	});
    $("#subject<?php echo $i;?>").on('change',function(){
		var semesterId=$(this).val();
		$.ajax({
			method:"POST",
			url:"ajax/sub_date_ajax.php",
			data:{id:semesterId},
			dataType:"html",
			success:function(data){
    ...
    $("#subject<?php echo $i;?>").on('change',function(){
		...
		$.ajax({
			method:"POST",
			url:"ajax/sub_time_ajax.php",
			data:{id:semesterId},
			dataType:"html",
			success:function(data){
				$("#time<?php echo $i;?>").html(data);
			}
		});
	});
});
