                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            ...
                            <form class="app-search p-l-20" action="subject_details_search.php" method = "post">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									<div class="col-md-2">
										<button class="btn btn-success"><a href="../admin/subject_details_add.php" style="color:white;text-decoration:none;"><i class="fa fa-plus m-r-10" style="font-size:18px;text-align:center" aria-hidden="true"> Add Subject</i></a></button>
									</div>
                                       <div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-12">
										<h2 class="text-danger text-center">Subject Details</h2>
