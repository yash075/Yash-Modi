        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <a href="assign_block_add_single.php"><button class="btn btn-success"><i class="fa fa-plus m-r-10" style="font-size:18px;text-align:center" aria-hidden="true"></i>Range Student Assign in Block</button></a>
                </div>
                <!-- ============================================================== -->
                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										<form action="assign_block_add_single_val.php" method="POST">
		...
		$.ajax({
			...
			success:function(data){
				$("#studs").html(data);
                                             ...
                                             <label for="studs" style="color:blue;font-size:20px;">Student Id</label>
