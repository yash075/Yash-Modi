                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										<form action="student_details_add_val.php" method="post">
                                            
                                            <label style="color:blue;font-size:20px;">Student code</label>
											<input type="text" class="form-control" name="stud_code" maxlength="11"><br><br>
                                            
                                            <label style="color:blue;font-size:20px;">Student Name</label>
											<input type="text" class="form-control" name="stud_name" required><br><br>
			                               ...
			                               <?php
											...
											<input type="text" class="form-control" name="stud_mobile" maxlength="12" required><br><br>
                                            
                                            <label style="color:blue;font-size:20px;">Student Mail</label>
                                            <input type="email" class="form-control" name="stud_mail" required><br><br>
