                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
									<div class="col-md-2">
										<button class="btn btn-success"><a href="../admin/block_arrangement_multiple_add.php?id=<?php echo $g;?>" style="color:white;text-decoration:none;"><i class="fa fa-plus m-r-10" style="font-size:18px;text-align:center" aria-hidden="true"></i>Add Block</a></button>
                                      </div>
									...
									<div class="col-md-12">
										...
										<table class="table table-bordered" style="text-align:center;">
											...
											<?php
												...
												$sql = "SELECT block_arrangement.b_arr_no,exam_schedule_theory.date,exam_schedule_theory.time,semester.sem_code,course.course_name,faculty.f_code,faculty.f_name FROM block_arrangement INNER JOIN exam_schedule_theory ON exam_schedule_theory.exam_sch_th_id=block_arrangement.exam_sch_th_id INNER JOIN subject ON subject.sub_id=exam_schedule_theory.sub_id INNER JOIN semester ON semester.sem_id=subject.sem_id INNER JOIN course ON course.course_id=semester.course_id JOIN faculty ON faculty.f_id=block_arrangement.f_id JOIN room_arrangement ON room_arrangement.r_id=block_arrangement.r_id WHERE block_arrangement.r_id='$g';";
											...
											<tbody>
                                               ...
                                               <td><input type="checkbox" id="checkItem" name="check[]" value="<?php echo $row["sem_id"]; ?>"></td>
                                                    ...
                                                    <td><?php echo $row['f_code']." - ".$row['f_name'];?></td>
                                                     <td>0</td>
