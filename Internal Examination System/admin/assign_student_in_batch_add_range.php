        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <a href="assign_student_in_batch_add.php"><button class="btn btn-success"><i class="fa fa-plus m-r-10" style="font-size:18px;text-align:center" aria-hidden="true"></i>Single Student Assign in Batch</button></a>
                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										<form action="assign_student_in_batch_add_range_val.php" method="post">
			                               ...
			                               <?php
                                            ...
                                            <label for="semester" style="color:blue;font-size:20px;">select Semester</label>
                                             ...
                                             <label for="studentstart" style="color:blue;font-size:20px;">Start Student Id</label>
                                              <select name="stud_start_id" class="form-control" id="studentstart" required>
                                            ...
                                            <label for="studentend" style="color:blue;font-size:20px;">End Student Id</label>
                                              <select name="stud_end_id" class="form-control" id="studentend" required>
...
$(document).ready(function(){
    ...
    $("#semester").on('change',function(){
		...
		$.ajax({
			...
			dataType:"html",
			success:function(data){
				$("#studentstart").html(data);
			}
		});
	});
    
    $("#studentstart").on('change',function(){
		var studentstartId=$(this).val();
		$.ajax({
			method:"POST",
			url:"ajax/student_end_ajax.php",
			data:{stud_id:studentstartId},
			dataType:"html",
			success:function(data){
				$("#studentend").html(data);
			}
		});
	});
});
