                    ...
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                           <li class="breadcrumb-item"><a href="../admin/examination_schedule.php">Exam Generation</a></li>
                            ...
                            <li class="breadcrumb-item active">Add Theory Schedule</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-block">
                                <div class="row">
                                    ...
                                    <?php 
                                        ...
                                        subject where sem_id='$sem' and sub_type='theory' ;";
                                        ...
                                        <table class="table table-stripped"  style="text-align:center;">
                                            ...
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="date" class="form-control" name="dateval<?php echo $i;?>" value="<?php echo $date;?>" min="<?php echo $dat['startdate'];?>">
                                                    </td>
                                                    <td>
