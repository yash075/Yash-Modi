                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										...
										<form action="../admin/sem_batch_details_add_val.php" method="post">
                                            ...
                                            <label style="color:blue;font-size:20px;">Course name and Semester</label>
                                             <select name="sem_id" class="form-control" required>
                                                 ...
                                                 <?php
														...
														$sql = "select semester.sem_id,semester.sem_code,course.course_name from semester inner join course on semester.course_id=course.course_id order by semester.sem_code; ";
