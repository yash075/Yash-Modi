        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="../admin/sem_batch_details.php">Semester Details</a></li>
				...
				<?php
                    ...
                    $query = "select sem_batch.batch_name,semester.sem_id,semester.sem_code,course.course_name from sem_batch inner join semester on semester.sem_id=sem_batch.sem_id inner join course on semester.course_id=course.course_id where sem_batch.batch_id='$d';";
                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										<form action="sem_batch_details_update_val.php?id=<?php echo $d;?>" method="post">
											...
											<input type="text" class="form-control" name="batch_name" value="<?php echo $num['batch_name']; ?>" required><br><br>
