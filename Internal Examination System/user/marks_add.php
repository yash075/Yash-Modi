				...
				<!--	<header>
						...
						<section class="wrapper style5">
							...
							<?php 
								  include '../user/connection.php';
										...
										$query1=mysqli_query($con,"select subject.*,semester.*,course.* from subject inner join semester on semester.sem_id=subject.sem_id inner join course on course.course_id=semester.course_id where subject.sub_id='$sub' AND subject.sub_type='$st';");
                    ...
                    {  
				        ...
				        }else
                        {
                            ...
                            {
					               if($row1['sub_type']=="theory" or $row1['sub_type']=="Theory" )
                                   {
					  ...
					  if($row1['sub_type']=='practical' or $row1['sub_type']=='Practical'){
                          $query2=mysqli_query($con,"select * from exam_generation where exam_id='0';");
						while($row2=mysqli_fetch_assoc($query2)){
