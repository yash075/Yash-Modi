                    ...
                    <?php $cid=$_REQUEST['cid'];?>
                      <li> <?php if(isset($_REQUEST['set'])){
                                if(isset($_REQUEST['wish'])){?>
                                  <a href="wishlist.php?set=true"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                                <?php }else{ ?>
                      <a href="viewshop.php?set=true&cid=<?php echo $cid;?>"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                      <?php }}else{?> 
                        <a href="viewshop.php?cid=<?php echo $cid;?>"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                      <?php } ?>
                      </li>
                    </ul>
                  </nav>
