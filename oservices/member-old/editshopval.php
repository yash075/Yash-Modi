		...
		if(isset($_POST['submit']))
        {
          ...
          $pathimg2=$folder2.$img2;
            ...
            else
            {
                ...
                //move_uploaded_file($servepathimg1,$pathimg1);
                //move_uploaded_file($servepathimg2,$pathimg2);
                $qry1 = "insert into shop(`shop_id`, `s_c_id`, `name`, `address`, `image`, `img1`, `m_id`, `shop_mob`, `shop_mail`, `location`,`description`) values (NULL,'$subcat','$name','$add','$pathimg1','$pathimg2','$id1','$mobile','$mail','$loc','$desc')";
