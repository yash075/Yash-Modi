	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" action="../log_shop/regshopval.php" method="post">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter Name">
						<input class="input100" type="text" name="name" placeholder="Name"  value="<?php if(isset($_COOKIE['namesc'])){echo $_COOKIE['namesc'];}?>" required>
						<span class="focus-input100"></span>
					</div>
                    
					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter Mail">
						<input class="input100" type="email" name="mail" placeholder="E-mail" value="<?php if(isset($_COOKIE['mailsc'])){echo $_COOKIE['mailsc'];}?>" required>
						<span class="focus-input100"></span>
                    </div>

					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter Mobile no.">
						<input class="input100" type="tel" name="mob" placeholder="Mobile no." pattern="[0-9]{10}" value="<?php if(isset($_COOKIE['mobsc'])){echo $_COOKIE['mobsc'];}?>" required>
						<span class="focus-input100"></span>
					</div>
