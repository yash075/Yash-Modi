	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" action="indexuserval.php" method="post">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter Mobile no.">
						<input class="input100" type="text" name="info" placeholder="Mobile no. Or Mail id">
					...
					<div class="text-right p-t-13 p-b-23">
						...
						<a href="userpassword.php" class="txt2">
							 Password?
						</a>
					</div>
