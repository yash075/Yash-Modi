...
<head>
  ...
  <title>Shop Serenity - Change Password</title>
...
else if(document.changepassword.curr.value==document.changepassword.con.value)
{
        ...
        <form action="" method="POST"  enctype="multipart/form-data" name="changepassword" onsubmit="return checkpass();">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="password" id="curr" name="curr" class="form-control" placeholder="Current Password" required="required">
