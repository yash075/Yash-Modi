 ...
 <!-- Navbar -->
  ...
  <div id="wrapper">
    ...
    <div class="card card-register mx-auto mt-5">
      <div class="card-header"><b>Update</b> Profile</div>
      <div class="card-body">
        <form action="" method="POST"  enctype="multipart/form-data" name="changepassword" onsubmit="return checkpass();">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="inputname" name="name" class="form-control" value="<?php echo $row1['m_name'];?>" placeholder="Name" required="required">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="inputmob" name="mob" class="form-control" value="<?php echo $row1['m_mob'];?>" placeholder="mobile" required="required">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="email" id="inputmail" name="mail" class="form-control" value="<?php echo $row1['m_mail'];?>" placeholder="mail" required="required">
