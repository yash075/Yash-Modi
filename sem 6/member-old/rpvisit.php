...
<head>
  ...
  <title>Shop Serenity - Visits</title>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                ...
                <tbody>
                        ...
                        ?>
                            <tr>
                            <td><?php echo $no;$sid=$row['shop_id'];?></td>
                            <td><?php echo ucwords($row['name']);?></td>
                            <td><?php echo ucwords($row['s_c_name'])."<br>(".ucwords($row['c_name']).")";?></td>
                            <td><?php $qv=mysqli_query($con,"select visit from shop where m_id='$id1' And shop_id='$sid'");
                                    $res=mysqli_fetch_assoc($qv);
                                    echo $res['visit'];
                            ?></td>
                            </tr>
                              <?php 
