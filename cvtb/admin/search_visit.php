            ...
            <div class="page-container">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <form class="form-header" action="search_visit.php" method="post">
...
?>   
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &emsp;&emsp; &emsp; &emsp; &emsp;&emsp; &emsp;<button type="submit" class="btn btn-danger" name="del"><i class="fa fa-trash m-r-10" style="font-size:18px" aria-hidden="true"></i>Delete</button>
                                    <br><br>	
                       ...
                       <th>Action</th>
                                           ...
                                           if(isset($_REQUEST['searchdata'])) {
                                            $g = $_REQUEST['searchdata'];
                                                    $ret =mysqli_query($con,"select schedule_visitor.*,visitor_log_detail.* from schedule_visitor inner join visitor_log_detail on
                                                    schedule_visitor.v_id=visitor_log_detail.v_id where visitor_log_detail.name like '%$g%' OR schedule_visitor.reason like '%$g%' 
                                                    OR schedule_visitor.date like '%$g%' OR schedule_visitor.time like '%$g%'");
                                                }
                                                else
                                                {
                                                    $ret=mysqli_query($con,"select schedule_visitor.*,visitor_log_detail.* from schedule_visitor inner join visitor_log_detail on
                                                    schedule_visitor.v_id=visitor_log_detail.v_id");
                                                }
    ...
    ?>
                  ...
                  <tr>
                    <td><input type="checkbox" id="checkItem" name="check[]" value="<?php echo $row["sch_v_id"]; ?>"></td>
                      <td><?php echo $cnt;?></td>
