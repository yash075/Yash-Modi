...
$cvmsaid=$_SESSION['cvmsaid'];
 ...
 $mobile=$_POST['mobile'];
 $pass=$_POST['password'];
 $query=mysqli_query($con,"insert into employee values('NULL','$dept','$ename','$post','$email','$mobile','$pass')");

    if ($query) {
    //$msg="Visitors Detail has been added.";
    $q1="SELECT * FROM `employee` WHERE  `e_name` LIKE '$ename'";
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Add</strong> New employee
                                    </div>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="empname" name="empname" placeholder="Employee Name" class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                <input type="text" id="post" name="post" placeholder="Enter Post" class="form-control" required="">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="mobilenumber" name="mobile" placeholder="Mobile Number" class="form-control" maxlength="10" required="">
                                                </div>
                                            </div>
