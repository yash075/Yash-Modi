            ...
            <div class="page-container">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <form class="form-header" action="dept_search.php" method="post">
                                <input class="au-input au-input--xl" type="text" name="searchdata" id="searchdata" placeholder="Search by names " />
...
?>   
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &emsp;&emsp;<a href="add_dept.php" class="btn btn-danger"><i class="fa fa-plus m-r-10" style="font-size:18px" aria-hidden="true"></i>Add</a>
                       ...
                       <th>Action</th>
                                           ...
                                           if(isset($_REQUEST['searchdata'])) {
                                            $g = $_REQUEST['searchdata'];
                                                    $ret =mysqli_query($con,"select * from department where  d_name like '%$g%' order by d_name;");
                                                }
                                                else
                                                {
                                                    $ret=mysqli_query($con,"select * from department order by d_name");
                                                }
    ...
    ?>
                    ...
                    <tr>
                    <td><input type="checkbox" id="checkItem" name="check[]" value="<?php echo $row["d_id"]; ?>"></td>
                      <td><?php echo $cnt;?></td>
                       <td><?php echo $row['d_name'];?>
                       </td>
                     <td><a href="edit_dept.php?id=<?php echo $row['d_id'];?>" title="View Full Details"><i class="fa fa-edit fa-1x"></i></a></td>
                    </tr>
                    <?php 
    $cnt=$cnt+1;
    }?>
