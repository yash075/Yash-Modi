                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" name="search" action="visitor_search.php" method="post">
...
?>
                ...
                <td><a href="sch-visitor.php?addid=<?php echo $row['v_id'];?>" title="View Full Details"><i class="fa fa-plus m-r-10"></i></a></td>
                  <td><a href="visitor-detail-edit.php?editid=<?php echo $row['v_id'];?>" title="View Full Details"><i class="fa fa-edit fa-1x"></i></a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
