...
?>   
    ...
    schedule_visitor.v_id=visitor_log_detail.v_id order by schedule_visitor.date");
    $cnt=1;
    ...
    ?>
                    ...
                    <tr>
                    <td><input type="checkbox" id="checkItem" name="check[]" value="<?php echo $row["sch_vi_id"]; ?>"></td>
                      <td><?php echo $cnt;?></td>
