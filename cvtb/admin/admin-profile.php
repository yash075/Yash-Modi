...
if (strlen($_SESSION['cvmsaid']==0)) {
  ...
  $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "update admin set a_name='$AName', a_mob ='$mobno', a_mail= '$email' where a_id='$adminid'");
    if ($query) {
...
?>   
   ...
   <?php
$adminid=$_SESSION['cvmsaid'];
$ret=mysqli_query($con,"select * from admin where a_id='$adminid'");
$cnt=1;
...
?>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="adminname" name="adminname" value="<?php  echo $row['a_name'];?>" class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="email" id="email" name="email" value="<?php  echo $row['a_mail'];?>" class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="mobilenumber" name="mobilenumber" class="form-control" maxlength="10" value="<?php  echo $row['a_mob'];?>" required="">
