								...
								<table class="table table-bordered" >
											<thead><b>
												<tr style="color:blue;font-size:20px;">
												    <th style="text-align:center;">Cancle</th>
											...
											<?php
												...
												include('includes/dbconnection.php');
															...
															where schedule_visitor.v_id='$s' and visit_record.status=0 AND schedule_visitor.date>=CURDATE();";
											...
											<tbody>
												<tr>
												<td style="text-align:center;"><a href="cancle.php?vid=<?php echo $row['v_rec_id'];?>" style="color:red;">X</a></td>
