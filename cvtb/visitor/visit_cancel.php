								...
								<table class="table table-bordered" >
											...
											<?php
												...
												include('includes/dbconnection.php');
															...
															$s = $_SESSION["cvmsaid"];
												            $sql = "select visit_record.*,schedule_visitor.*,visitor_log_detail.* from visit_record inner join schedule_visitor on schedule_visitor.sch_vi_id=visit_record.sch_v_id inner join visitor_log_detail on schedule_visitor.v_id=visitor_log_detail.v_id where schedule_visitor.v_id='$s' and visit_record.status=-1;";
