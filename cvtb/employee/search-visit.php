...
visitor_log_detail.v_id=schedule_visitor.v_id where schedule_visitor.e_id='$eid' AND visit_record.status='1' AND 
schedule_visitor.date=CURDATE() AND (visitor_log_detail.name='$search' OR schedule_visitor.reason='$search' OR schedule_visitor.date='$search') order by schedule_visitor.date");
$cnt=1;
