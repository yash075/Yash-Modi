...
<body class="animsition">
  ...
  <?php
 $eid=$_GET['editid'];
  $testres1=mysqli_query($con,"select * from visitor_log_detail where v_id='$eid'");
  while ($row=mysqli_fetch_array($testres1)) {
    ...
    ?><table border="1" class="table table-bordered mg-b-0">
      ...
      <tr>
        <th>Photo</th>
        <td><img src="<?php  echo $row['img'];?>" style="height:100px;width:100px;"></td>
      </tr>
      <tr>
        <th>Resume / File</th>
        <td><a href="<?php echo $row['info'];?>" target="_blank">View File</a></td>
      </tr>
     <!-- <tr>
