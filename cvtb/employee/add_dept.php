...
$cvmsaid=$_SESSION['cvmsaid'];
 ...
 $query=mysqli_query($con,"insert into department values('NULL','$dname')");

    if ($query) {
    //$msg="Visitors Detail has been added.";
    $q1="SELECT * FROM `department` WHERE  `d_name` LIKE '$dname'";
                                           ...
                                           <!-- <div class="resume">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="deptname" name="deptname" placeholder="Department Name" class="form-control" required="">
