...
$name=$_POST['deptname'];
 $query=mysqli_query($con,"update department set d_name='$name' where  d_id='$id'");
                                         ...
                                         ?>   
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="deptname" name="deptname" value="<?php echo $row['d_name'];?>" placeholder="Department Name" class="form-control" required="">
