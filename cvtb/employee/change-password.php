...
$query=mysqli_query($con,"select e_id from employee where e_id='$eid' and   password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update employee set password='$newpassword' where e_id='$eid'");
