...
$query=mysqli_query($con,"select a_id from admin where a_id='$adminid' and   a_pass='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update admin set a_pass='$newpassword' where a_id='$adminid'");
...
$adminid=$_SESSION['cvmsaid'];
$id=$_GET['id'];
$ret=mysqli_query($con,"select schedule_visitor.*,visitor_log_detail.* from schedule_visitor inner join 
visitor_log_detail on schedule_visitor.v_id=visitor_log_detail.v_id  where schedule_visitor.sch_v_id='$id'");
...
?>
                                            <!--<div class="row form-group">
                                                ...
                                                <center><img src="<?php  echo $row['img'];?>" width="20%" height="30%"></center><br>
