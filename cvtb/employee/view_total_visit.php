...
visitor_log_detail.v_id=schedule_visitor.v_id where schedule_visitor.e_id='$eid' AND visit_record.status='1' order by schedule_visitor.date");
$cnt=1;
